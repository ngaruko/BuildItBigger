...
public final class Joke extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Joke> jokeList;
   ...
   */
  public Joke setId(java.lang.Integer id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Joke> getJokeList() {
    return jokeList;
  }
   ...
   */
  public Joke setJokeList(java.util.List<Joke> jokeList) {
